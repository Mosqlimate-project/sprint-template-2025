...
Let's for the sake of this example fit the dengue series for the state of Distrito Federal (UF="DF"). For this we need to aggregate the cases from all 92 municipalities of the state.
...
## Creating a Proohet forecast model for the challenge
...
key = c("ZuilhoSe:bbfa2e47-c0d8-4b8f-999d-5ab596d7ec25")
names(key) <- 'X-UID-Key'
model <- list(
